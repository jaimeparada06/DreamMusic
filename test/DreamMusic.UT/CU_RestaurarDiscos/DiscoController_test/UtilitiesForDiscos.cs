...
namespace DreamMusic.UT.CU_RestaurarDiscos
{
    public static class UtilitiesForDiscos
    {
        ...
        public static void InitializeDbDiscosForTests(ApplicationDbContext db)
        {
            ...
            db.Users.Add(new Administrador { Id = "1", UserName = "elena@uclm.com", PhoneNumber = "967959598", Email = "elena@uclm.com", Name = "Elena", Apellido1 = "Navarro", Apellido2 = "Martínez" });
            db.SaveChanges();
